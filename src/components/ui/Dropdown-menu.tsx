...
const menuItem =
  "relative flex min-h-10 sm:min-h-9 cursor-pointer select-none items-center rounded-lg px-2.5 py-2 text-sm leading-5 outline-none transition-colors motion-reduce:transition-none focus:bg-brand/15 focus:text-zinc-50 data-[highlighted]:bg-brand/15 data-[highlighted]:text-zinc-50 data-[disabled]:pointer-events-none data-[disabled]:opacity-40 [&>svg]:shrink-0";
...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ...
    className={cn(
      menuItem,
      "data-[state=open]:bg-brand/10 data-[state=open]:text-zinc-50",
      inset && "pl-8",
      className
    )}
    {...props}
...
>(({ className, children, checked, ...props }, ref) => (
  <DropdownMenuPrimitive.CheckboxItem
    ...
    className={cn(
      menuItem,
      "pl-8 data-[state=checked]:bg-brand/10",
      className
    )}
    checked={checked}
    {...props}
...
>(({ className, inset, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    ref={ref}
    className={cn(
      "px-2.5 py-2 text-xs font-medium text-zinc-400",
      inset && "pl-8",
      className
    )}
    {...props}
...
const DropdownMenuShortcut = ({
  ...
  return (
    <span
      className={cn("ml-auto pl-4 text-xs tracking-wide text-zinc-400", className)}
      {...props}
    />
  );
};
