...
export default function ViewSelector<T extends CollectionView>({
  value,
  onChange,
  options,
  ...
  return (
    <div
      role="group"
      aria-label={label}
      className="theme-selector-shell inline-flex w-fit shrink-0 gap-1 rounded-xl border bg-zinc-900/60 p-1"
    >
      {options.map((view) => {
